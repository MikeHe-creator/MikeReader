...
import destr from 'file://E:/document%20file/JavaScript/JavaScrpit/vuep01/MikeReader/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://E:/document%20file/JavaScript/JavaScrpit/vuep01/MikeReader/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://E:/document%20file/JavaScript/JavaScrpit/vuep01/MikeReader/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://E:/document%20file/JavaScript/JavaScrpit/vuep01/MikeReader/node_modules/scule/dist/index.mjs';
...
import { version, unref } from 'file://E:/document%20file/JavaScript/JavaScrpit/vuep01/MikeReader/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://E:/document%20file/JavaScript/JavaScrpit/vuep01/MikeReader/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://E:/document%20file/JavaScript/JavaScrpit/vuep01/MikeReader/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"E:/document file/JavaScript/JavaScrpit/vuep01/MikeReader/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\document file\\JavaScript\\JavaScrpit\\vuep01\\MikeReader","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\document file\\JavaScript\\JavaScrpit\\vuep01\\MikeReader\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\document file\\JavaScript\\JavaScrpit\\vuep01\\MikeReader\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\document file\\JavaScript\\JavaScrpit\\vuep01\\MikeReader\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\document file\\JavaScript\\JavaScrpit\\vuep01\\MikeReader\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _M3elvgkKpG = (function(nitro) {
...
const _lazy_ZtoQju = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_ZtoQju, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ZtoQju, lazy: true, middleware: false, method: undefined }
];
